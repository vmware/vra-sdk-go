...
func (m *MachineResult) validateContent(formats strfmt.Registry) error {
...
func (m *MachineResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*Machine(m.Content)); err != nil {
		return err
	}
...
func (m *MachineResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MachineResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
