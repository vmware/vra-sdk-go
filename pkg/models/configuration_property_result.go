...
// Validate validates this configuration property result
...
func (m *ConfigurationPropertyResult) validateContent(formats strfmt.Registry) error {
...
func (m *ConfigurationPropertyResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*ConfigurationProperty(m.Content)); err != nil {
		return err
	}
...
func (m *ConfigurationPropertyResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigurationPropertyResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigurationPropertyResult) UnmarshalBinary(b []byte) error {
	var res ConfigurationPropertyResult
