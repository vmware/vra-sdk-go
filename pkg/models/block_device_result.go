...
func (m *BlockDeviceResult) validateContent(formats strfmt.Registry) error {
...
func (m *BlockDeviceResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*BlockDevice(m.Content)); err != nil {
		return err
	}
...
func (m *BlockDeviceResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BlockDeviceResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
