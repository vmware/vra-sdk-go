...
func (m *LoadBalancer) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoadBalancer) contextValidateRoutes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoadBalancer) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
