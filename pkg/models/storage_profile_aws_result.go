...
func (m *StorageProfileAwsResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*AwsStorageProfile(m.Content)); err != nil {
		return err
	}
...
func (m *StorageProfileAwsResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageProfileAwsResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
