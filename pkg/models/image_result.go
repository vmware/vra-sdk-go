...
func (m *ImageResult) validateContent(formats strfmt.Registry) error {
...
func (m *ImageResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*ImageMapping(m.Content)); err != nil {
		return err
	}
...
func (m *ImageResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ImageResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
