...
func (m *PageOfBlueprintContentSource) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfBlueprintContentSource) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfBlueprintContentSource) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfBlueprintContentSource) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfBlueprintContentSource) UnmarshalBinary(b []byte) error {
	var res PageOfBlueprintContentSource
