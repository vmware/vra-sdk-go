...
func (m *LoadBalancerResult) validateContent(formats strfmt.Registry) error {
...
func (m *LoadBalancerResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*LoadBalancer(m.Content)); err != nil {
		return err
	}
...
func (m *LoadBalancerResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoadBalancerResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
