...
func (m *NetworkIPRange) validateLinks(formats strfmt.Registry) error {
...
func (m *NetworkIPRange) validateEndIPAddress(formats strfmt.Registry) error {
...
func (m *NetworkIPRange) validateID(formats strfmt.Registry) error {
...
var networkIpRangeTypeIPVersionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		networkIpRangeTypeIPVersionPropEnum = append(networkIpRangeTypeIPVersionPropEnum, v)
	}
}
...
// prop value enum
func (m *NetworkIPRange) validateIPVersionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, networkIpRangeTypeIPVersionPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *NetworkIPRange) validateIPVersion(formats strfmt.Registry) error {
...
func (m *NetworkIPRange) validateStartIPAddress(formats strfmt.Registry) error {
...
func (m *NetworkIPRange) validateTags(formats strfmt.Registry) error {
...
func (m *NetworkIPRange) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkIPRange) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
