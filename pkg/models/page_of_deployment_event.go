...
// PageOfDeploymentEvent PageOfDeploymentEvent
// swagger:model PageOfDeploymentEvent
...
func (m *PageOfDeploymentEvent) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfDeploymentEvent) validateSort(formats strfmt.Registry) error {
