...
// Validate validates this page of notification scenario config
...
func (m *PageOfNotificationScenarioConfig) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfNotificationScenarioConfig) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfNotificationScenarioConfig) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfNotificationScenarioConfig) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfNotificationScenarioConfig) UnmarshalBinary(b []byte) error {
	var res PageOfNotificationScenarioConfig
