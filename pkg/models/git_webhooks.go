...
// ContextValidate validate this git webhooks based on the context it is used
func (m *gitWebhooks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *gitWebhooks) contextValidateDocuments(ctx context.Context, formats strfmt.Registry) error {
