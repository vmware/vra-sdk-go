...
func (m *FolderResult) validateContent(formats strfmt.Registry) error {
...
func (m *FolderResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*Folder(m.Content)); err != nil {
		return err
	}
...
func (m *FolderResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FolderResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
