...
// Validate validates this bulk create deployment request
...
func (m *BulkCreateDeploymentRequest) validateDeployments(formats strfmt.Registry) error {
...
func (m *BulkCreateDeploymentRequest) contextValidateDeployments(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BulkCreateDeploymentRequest) UnmarshalBinary(b []byte) error {
	var res BulkCreateDeploymentRequest
