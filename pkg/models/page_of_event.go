...
func (m *PageOfEvent) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfEvent) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfEvent) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfEvent) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
