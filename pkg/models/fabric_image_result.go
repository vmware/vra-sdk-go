...
func (m *FabricImageResult) validateContent(formats strfmt.Registry) error {
...
func (m *FabricImageResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*FabricImage(m.Content)); err != nil {
		return err
	}
...
func (m *FabricImageResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FabricImageResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
