...
func (m *FlavorProfileResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*FlavorProfile(m.Content)); err != nil {
		return err
	}
...
func (m *FlavorProfileResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlavorProfileResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
