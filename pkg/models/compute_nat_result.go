...
func (m *ComputeNatResult) validateContent(formats strfmt.Registry) error {
...
func (m *ComputeNatResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*ComputeNat(m.Content)); err != nil {
		return err
	}
...
func (m *ComputeNatResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ComputeNatResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
