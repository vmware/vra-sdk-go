...
// ContextValidate validate this pipelines based on the context it is used
func (m *pipelines) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *pipelines) contextValidateDocuments(ctx context.Context, formats strfmt.Registry) error {
