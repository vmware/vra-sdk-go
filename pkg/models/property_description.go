	...
	if m.ElementDescription != nil {
		if err := m.ElementDescription.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("elementDescription")
			}
			return err
		}
	}
	...
	for k := range m.FieldDescriptions {
		...
		if val, ok := m.FieldDescriptions[k]; ok {
			if err := val.Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("fieldDescriptions" + "." + k)
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("fieldDescriptions" + "." + k)
				}
				return err
			}
		}
...
func (m *PropertyDescription) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateElementDescription(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *PropertyDescription) contextValidateElementDescription(ctx context.Context, formats strfmt.Registry) error {

	if m.ElementDescription != nil {
		if err := m.ElementDescription.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("elementDescription")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("elementDescription")
...
func (m *PropertyDescription) contextValidateFieldDescriptions(ctx context.Context, formats strfmt.Registry) error {
