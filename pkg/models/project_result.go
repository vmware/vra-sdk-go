...
func (m *ProjectResult) validateContent(formats strfmt.Registry) error {
...
func (m *ProjectResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProjectResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
