...
func (m *BlueprintPlan) contextValidateTasks(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "tasks", "body", []*BlueprintPlanTask(m.Tasks)); err != nil {
		return err
	}
