...
func (m *PageOfCommitDetails) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfCommitDetails) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfCommitDetails) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfCommitDetails) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
