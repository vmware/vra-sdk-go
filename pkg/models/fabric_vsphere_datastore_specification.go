...
// Validate validates this fabric vsphere datastore specification
...
func (m *FabricVsphereDatastoreSpecification) validateTags(formats strfmt.Registry) error {
...
func (m *FabricVsphereDatastoreSpecification) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FabricVsphereDatastoreSpecification) UnmarshalBinary(b []byte) error {
	var res FabricVsphereDatastoreSpecification
