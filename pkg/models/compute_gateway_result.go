...
func (m *ComputeGatewayResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*ComputeGateway(m.Content)); err != nil {
		return err
	}
...
func (m *ComputeGatewayResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ComputeGatewayResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
