...
func (m *PageOfCatalogItemVersion) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfCatalogItemVersion) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfCatalogItemVersion) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfCatalogItemVersion) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfCatalogItemVersion) UnmarshalBinary(b []byte) error {
	var res PageOfCatalogItemVersion
