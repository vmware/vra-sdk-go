...
func (m *CloudAccountVcfResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*CloudAccountVcf(m.Content)); err != nil {
		return err
	}
...
func (m *CloudAccountVcfResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloudAccountVcfResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
