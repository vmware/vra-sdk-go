...
func (m *PageOfDeploymentResource) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfDeploymentResource) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfDeploymentResource) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfDeploymentResource) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfDeploymentResource) UnmarshalBinary(b []byte) error {
	var res PageOfDeploymentResource
