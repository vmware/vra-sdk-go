...
// Validate validates this page of supervisor namespace
...
func (m *PageOfSupervisorNamespace) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfSupervisorNamespace) validatePageable(formats strfmt.Registry) error {
...
func (m *PageOfSupervisorNamespace) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfSupervisorNamespace) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfSupervisorNamespace) contextValidatePageable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfSupervisorNamespace) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfSupervisorNamespace) UnmarshalBinary(b []byte) error {
	var res PageOfSupervisorNamespace
