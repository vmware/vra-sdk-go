...
func (m *NetworkProfileResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*NetworkProfile(m.Content)); err != nil {
		return err
	}
...
func (m *NetworkProfileResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkProfileResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
