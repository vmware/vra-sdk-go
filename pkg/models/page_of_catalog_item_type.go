...
func (m *PageOfCatalogItemType) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfCatalogItemType) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfCatalogItemType) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfCatalogItemType) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
