...
func (m *IaaSDeployment) validateLinks(formats strfmt.Registry) error {
...
func (m *IaaSDeployment) validateID(formats strfmt.Registry) error {
...
func (m *IaaSDeployment) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
