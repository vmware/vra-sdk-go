...
func (m *IaaSProjectResourceMetadata) validateTags(formats strfmt.Registry) error {
...
func (m *IaaSProjectResourceMetadata) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IaaSProjectResourceMetadata) UnmarshalBinary(b []byte) error {
	var res IaaSProjectResourceMetadata
