...
func (m *ZoneResult) validateContent(formats strfmt.Registry) error {
...
func (m *ZoneResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*Zone(m.Content)); err != nil {
		return err
	}
...
func (m *ZoneResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ZoneResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
