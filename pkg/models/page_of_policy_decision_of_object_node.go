...
func (m *PageOfPolicyDecisionOfObjectNode) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfPolicyDecisionOfObjectNode) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
