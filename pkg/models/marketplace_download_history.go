...
func (m *MarketplaceDownloadHistory) validateLinks(formats strfmt.Registry) error {
...
func (m *MarketplaceDownloadHistory) validatePage(formats strfmt.Registry) error {
...
func (m *MarketplaceDownloadHistory) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MarketplaceDownloadHistory) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MarketplaceDownloadHistory) contextValidatePage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MarketplaceDownloadHistory) UnmarshalBinary(b []byte) error {
	var res MarketplaceDownloadHistory
