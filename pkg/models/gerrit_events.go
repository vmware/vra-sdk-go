...
// ContextValidate validate this gerrit events based on the context it is used
func (m *gerritEvents) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *gerritEvents) contextValidateDocuments(ctx context.Context, formats strfmt.Registry) error {
