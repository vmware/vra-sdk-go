...
func (m *StorageProfileAzureResult) validateContent(formats strfmt.Registry) error {
...
func (m *StorageProfileAzureResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*AzureStorageProfile(m.Content)); err != nil {
		return err
	}
...
func (m *StorageProfileAzureResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageProfileAzureResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageProfileAzureResult) UnmarshalBinary(b []byte) error {
	var res StorageProfileAzureResult
