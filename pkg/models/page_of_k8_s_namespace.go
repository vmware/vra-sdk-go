...
// Validate validates this page of k8 s namespace
func (m *PageOfK8SNamespace) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfK8SNamespace) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfK8SNamespace) validatePageable(formats strfmt.Registry) error {
...
func (m *PageOfK8SNamespace) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfK8SNamespace) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfK8SNamespace) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfK8SNamespace) contextValidatePageable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfK8SNamespace) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
