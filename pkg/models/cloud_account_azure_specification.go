...
func (m *CloudAccountAzureSpecification) validateRegions(formats strfmt.Registry) error {
...
func (m *CloudAccountAzureSpecification) contextValidateRegions(ctx context.Context, formats strfmt.Registry) error {
