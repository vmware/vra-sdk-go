...
func (m *NodeList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NodeList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
