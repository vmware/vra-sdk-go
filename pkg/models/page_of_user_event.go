...
// Validate validates this page of user event
func (m *PageOfUserEvent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfUserEvent) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfUserEvent) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfUserEvent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfUserEvent) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfUserEvent) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
