...
func (m *PageOfCatalogItem) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfCatalogItem) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfCatalogItem) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfCatalogItem) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
