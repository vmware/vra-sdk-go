...
func (m *RequestTrackerResult) validateContent(formats strfmt.Registry) error {
...
func (m *RequestTrackerResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*RequestTracker(m.Content)); err != nil {
		return err
	}
...
func (m *RequestTrackerResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RequestTrackerResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
