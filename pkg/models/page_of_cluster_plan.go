...
// Validate validates this page of cluster plan
func (m *PageOfClusterPlan) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfClusterPlan) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfClusterPlan) validatePageable(formats strfmt.Registry) error {
...
func (m *PageOfClusterPlan) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfClusterPlan) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfClusterPlan) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfClusterPlan) contextValidatePageable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfClusterPlan) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
