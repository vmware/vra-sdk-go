...
func (m *SliceOfEventLog) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SliceOfEventLog) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
