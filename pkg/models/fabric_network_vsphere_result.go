...
func (m *FabricNetworkVsphereResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*FabricNetworkVsphere(m.Content)); err != nil {
		return err
	}
...
func (m *FabricNetworkVsphereResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FabricNetworkVsphereResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
