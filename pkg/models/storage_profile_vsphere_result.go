...
func (m *StorageProfileVsphereResult) validateContent(formats strfmt.Registry) error {
...
func (m *StorageProfileVsphereResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*VsphereStorageProfile(m.Content)); err != nil {
		return err
	}
...
func (m *StorageProfileVsphereResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageProfileVsphereResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageProfileVsphereResult) UnmarshalBinary(b []byte) error {
	var res StorageProfileVsphereResult
