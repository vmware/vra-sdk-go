...
func (m *ExternalNetworkIPRangeResult) validateContent(formats strfmt.Registry) error {
...
func (m *ExternalNetworkIPRangeResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*ExternalNetworkIPRange(m.Content)); err != nil {
		return err
	}
...
func (m *ExternalNetworkIPRangeResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ExternalNetworkIPRangeResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ExternalNetworkIPRangeResult) UnmarshalBinary(b []byte) error {
	var res ExternalNetworkIPRangeResult
