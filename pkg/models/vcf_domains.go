...
func (m *VcfDomains) validateDomains(formats strfmt.Registry) error {
...
func (m *VcfDomains) contextValidateDomains(ctx context.Context, formats strfmt.Registry) error {
