...
func (m *FlavorResult) validateContent(formats strfmt.Registry) error {
...
func (m *FlavorResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*FlavorMapping(m.Content)); err != nil {
		return err
	}
...
func (m *FlavorResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlavorResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
