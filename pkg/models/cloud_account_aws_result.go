...
func (m *CloudAccountAwsResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*CloudAccountAws(m.Content)); err != nil {
		return err
	}
...
func (m *CloudAccountAwsResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloudAccountAwsResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
