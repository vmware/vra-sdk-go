...
// Validate validates this page of cluster group
func (m *PageOfClusterGroup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfClusterGroup) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfClusterGroup) validatePageable(formats strfmt.Registry) error {
...
func (m *PageOfClusterGroup) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfClusterGroup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfClusterGroup) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfClusterGroup) contextValidatePageable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfClusterGroup) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
