		...
		if val, ok := m.PropertyDescriptions[k]; ok {
			if err := val.Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("propertyDescriptions" + "." + k)
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("propertyDescriptions" + "." + k)
				}
				return err
			}
		}
		...
		for i := 0; i < len(m.ServiceRequestRoutes[k]); i++ {
			...
			if err := m.ServiceRequestRoutes[k][i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("serviceRequestRoutes" + "." + k + "." + strconv.Itoa(i))
				}
				return err
			}
...
func (m *ServiceDocumentDescription) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidatePropertyDescriptions(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateServiceRequestRoutes(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ServiceDocumentDescription) contextValidatePropertyDescriptions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceDocumentDescription) contextValidateServiceRequestRoutes(ctx context.Context, formats strfmt.Registry) error {

	for k := range m.ServiceRequestRoutes {

		for i := 0; i < len(m.ServiceRequestRoutes[k]); i++ {

			if err := m.ServiceRequestRoutes[k][i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("serviceRequestRoutes" + "." + k + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("serviceRequestRoutes" + "." + k + "." + strconv.Itoa(i))
