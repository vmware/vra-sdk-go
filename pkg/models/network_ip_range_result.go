...
func (m *NetworkIPRangeResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*NetworkIPRange(m.Content)); err != nil {
		return err
	}
...
func (m *NetworkIPRangeResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkIPRangeResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
