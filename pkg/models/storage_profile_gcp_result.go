...
// Validate validates this storage profile gcp result
...
func (m *StorageProfileGcpResult) validateContent(formats strfmt.Registry) error {
...
func (m *StorageProfileGcpResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*GcpStorageProfile(m.Content)); err != nil {
		return err
	}
...
func (m *StorageProfileGcpResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageProfileGcpResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageProfileGcpResult) UnmarshalBinary(b []byte) error {
	var res StorageProfileGcpResult
