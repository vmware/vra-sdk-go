...
func (m *NetworkDomain) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkDomain) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
