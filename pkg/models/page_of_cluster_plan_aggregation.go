...
// Validate validates this page of cluster plan aggregation
...
func (m *PageOfClusterPlanAggregation) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfClusterPlanAggregation) validatePageable(formats strfmt.Registry) error {
...
func (m *PageOfClusterPlanAggregation) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfClusterPlanAggregation) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfClusterPlanAggregation) contextValidatePageable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfClusterPlanAggregation) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfClusterPlanAggregation) UnmarshalBinary(b []byte) error {
	var res PageOfClusterPlanAggregation
