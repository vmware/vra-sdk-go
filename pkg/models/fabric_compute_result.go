...
func (m *FabricComputeResult) validateContent(formats strfmt.Registry) error {
...
func (m *FabricComputeResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*FabricCompute(m.Content)); err != nil {
		return err
	}
...
func (m *FabricComputeResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FabricComputeResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
