...
func (m *PageOfResourceType) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfResourceType) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfResourceType) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfResourceType) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
