...
func (m *PageOfCatalogSource) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfCatalogSource) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfCatalogSource) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfCatalogSource) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
