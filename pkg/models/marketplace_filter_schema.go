...
func (m *MarketplaceFilterSchema) validateFilters(formats strfmt.Registry) error {
...
func (m *MarketplaceFilterSchema) contextValidateFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MarketplaceFilterSchema) UnmarshalBinary(b []byte) error {
	var res MarketplaceFilterSchema
