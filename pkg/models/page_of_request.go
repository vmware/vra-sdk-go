...
func (m *PageOfRequest) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfRequest) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfRequest) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfRequest) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
