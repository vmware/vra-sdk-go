...
func (m *NetworkDomainResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*NetworkDomain(m.Content)); err != nil {
		return err
	}
...
func (m *NetworkDomainResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkDomainResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
