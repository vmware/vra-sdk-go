...
// Validate validates this integration result
func (m *IntegrationResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IntegrationResult) validateContent(formats strfmt.Registry) error {
...
func (m *IntegrationResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IntegrationResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*Integration(m.Content)); err != nil {
		return err
	}
...
func (m *IntegrationResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntegrationResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
