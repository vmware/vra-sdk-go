...
func (m *CloudAccountVsphereResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*CloudAccountVsphere(m.Content)); err != nil {
		return err
	}
...
func (m *CloudAccountVsphereResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloudAccountVsphereResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
