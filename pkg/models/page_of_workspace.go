...
// Validate validates this page of workspace
func (m *PageOfWorkspace) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfWorkspace) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfWorkspace) validatePageable(formats strfmt.Registry) error {
...
func (m *PageOfWorkspace) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfWorkspace) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfWorkspace) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfWorkspace) contextValidatePageable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfWorkspace) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
