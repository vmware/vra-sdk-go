...
func (m *FabricNetworkResult) validateContent(formats strfmt.Registry) error {
...
func (m *FabricNetworkResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*FabricNetwork(m.Content)); err != nil {
		return err
	}
...
func (m *FabricNetworkResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FabricNetworkResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
