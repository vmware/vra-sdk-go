...
// PageOfDataElement PageOfDataElement
// swagger:model PageOfDataElement
...
func (m *PageOfDataElement) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfDataElement) validateSort(formats strfmt.Registry) error {
