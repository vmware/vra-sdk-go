...
// ContextValidate validate this docker registry webhooks based on the context it is used
func (m *dockerRegistryWebhooks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *dockerRegistryWebhooks) contextValidateDocuments(ctx context.Context, formats strfmt.Registry) error {
