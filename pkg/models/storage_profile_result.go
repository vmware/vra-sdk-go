...
func (m *StorageProfileResult) validateContent(formats strfmt.Registry) error {
...
func (m *StorageProfileResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*StorageProfile(m.Content)); err != nil {
		return err
	}
...
func (m *StorageProfileResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageProfileResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
