...
// Validate validates this page of storage policy
func (m *PageOfStoragePolicy) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfStoragePolicy) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfStoragePolicy) validatePageable(formats strfmt.Registry) error {
...
func (m *PageOfStoragePolicy) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfStoragePolicy) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfStoragePolicy) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfStoragePolicy) contextValidatePageable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfStoragePolicy) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
