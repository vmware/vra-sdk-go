...
func (m *PageOfBlueprintVersion) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfBlueprintVersion) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfBlueprintVersion) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfBlueprintVersion) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfBlueprintVersion) UnmarshalBinary(b []byte) error {
	var res PageOfBlueprintVersion
