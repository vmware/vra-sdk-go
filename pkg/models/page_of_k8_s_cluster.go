...
// Validate validates this page of k8 s cluster
func (m *PageOfK8SCluster) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfK8SCluster) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfK8SCluster) validatePageable(formats strfmt.Registry) error {
...
func (m *PageOfK8SCluster) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfK8SCluster) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfK8SCluster) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfK8SCluster) contextValidatePageable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfK8SCluster) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
