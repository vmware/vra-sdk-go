...
// ContextValidate validate this gerrit listeners based on the context it is used
func (m *gerritListeners) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *gerritListeners) contextValidateDocuments(ctx context.Context, formats strfmt.Registry) error {
