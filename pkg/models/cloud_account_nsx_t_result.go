...
func (m *CloudAccountNsxTResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*CloudAccountNsxT(m.Content)); err != nil {
		return err
	}
...
func (m *CloudAccountNsxTResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CloudAccountNsxTResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
