...
func (m *PageOfBlueprint) validateContent(formats strfmt.Registry) error {
...
func (m *PageOfBlueprint) validateSort(formats strfmt.Registry) error {
...
func (m *PageOfBlueprint) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfBlueprint) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
