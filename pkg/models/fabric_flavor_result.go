...
func (m *FabricFlavorResult) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "content", "body", []*FabricFlavor(m.Content)); err != nil {
		return err
	}
...
func (m *FabricFlavorResult) contextValidateNumberOfElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FabricFlavorResult) contextValidateTotalElements(ctx context.Context, formats strfmt.Registry) error {
