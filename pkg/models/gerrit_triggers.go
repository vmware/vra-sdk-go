...
// ContextValidate validate this gerrit triggers based on the context it is used
func (m *gerritTriggers) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *gerritTriggers) contextValidateDocuments(ctx context.Context, formats strfmt.Registry) error {
