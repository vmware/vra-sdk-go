...
func (o *GetPolicyTypeScopeSchemaUsingGETReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetPolicyTypeScopeSchemaUsingGETOK()
...
func NewGetPolicyTypeScopeSchemaUsingGETOK() *GetPolicyTypeScopeSchemaUsingGETOK {
	return &GetPolicyTypeScopeSchemaUsingGETOK{}
}
...
func (o *GetPolicyTypeScopeSchemaUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /policy/api/policyTypes/{id}/scopeSchema][%d] getPolicyTypeScopeSchemaUsingGETOK  %+v", 200, o.Payload)
}
func (o *GetPolicyTypeScopeSchemaUsingGETOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetPolicyTypeScopeSchemaUsingGETOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
