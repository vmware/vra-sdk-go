...
for the get all using get1 operation typically these are written to a http.Request
*/
...
func (o *GetAllUsingGET1Params) WithPage(page *string) *GetAllUsingGET1Params {
	o.SetPage(page)
	return o
}
