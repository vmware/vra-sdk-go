...
type GetResourceActionsUsingGETOK struct {
	Payload *models.PageOfResourceAction
}

func (o *GetResourceActionsUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /deployment/api/admin/actions][%d] getResourceActionsUsingGETOK  %+v", 200, o.Payload)
}
...
func (o *GetResourceActionsUsingGETOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.PageOfResourceAction)
...
func (o *GetResourceActionsUsingGETUnauthorized) Error() string {
	return fmt.Sprintf("[GET /deployment/api/admin/actions][%d] getResourceActionsUsingGETUnauthorized ", 401)
}
...
func (o *GetResourceActionsUsingGETForbidden) Error() string {
	return fmt.Sprintf("[GET /deployment/api/admin/actions][%d] getResourceActionsUsingGETForbidden ", 403)
}
...
func (o *GetResourceActionsUsingGETNotFound) Error() string {
	return fmt.Sprintf("[GET /deployment/api/admin/actions][%d] getResourceActionsUsingGETNotFound ", 404)
}
