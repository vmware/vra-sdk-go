...
// NewGetFlavorProfilesParams creates a new GetFlavorProfilesParams object
// with the default values initialized.
func NewGetFlavorProfilesParams() *GetFlavorProfilesParams {
	var ()
	return &GetFlavorProfilesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetFlavorProfilesParamsWithTimeout creates a new GetFlavorProfilesParams object
...
// NewGetFlavorProfilesParamsWithContext creates a new GetFlavorProfilesParams object
...
// NewGetFlavorProfilesParamsWithHTTPClient creates a new GetFlavorProfilesParams object
...
// WithRegionID adds the regionID to the get flavor profiles params
func (o *GetFlavorProfilesParams) WithRegionID(regionID *string) *GetFlavorProfilesParams {
	o.SetRegionID(regionID)
	return o
}

// SetRegionID adds the regionId to the get flavor profiles params
func (o *GetFlavorProfilesParams) SetRegionID(regionID *string) {
	o.RegionID = regionID
}
