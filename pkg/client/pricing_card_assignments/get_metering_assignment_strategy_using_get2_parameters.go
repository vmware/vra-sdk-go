...
// NewGetMeteringAssignmentStrategyUsingGET2Params creates a new GetMeteringAssignmentStrategyUsingGET2Params object,
...
func NewGetMeteringAssignmentStrategyUsingGET2Params() *GetMeteringAssignmentStrategyUsingGET2Params {
	return &GetMeteringAssignmentStrategyUsingGET2Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetMeteringAssignmentStrategyUsingGET2ParamsWithTimeout creates a new GetMeteringAssignmentStrategyUsingGET2Params object
...
// NewGetMeteringAssignmentStrategyUsingGET2ParamsWithContext creates a new GetMeteringAssignmentStrategyUsingGET2Params object
...
// NewGetMeteringAssignmentStrategyUsingGET2ParamsWithHTTPClient creates a new GetMeteringAssignmentStrategyUsingGET2Params object
...
func (o *GetMeteringAssignmentStrategyUsingGET2Params) WithDefaults() *GetMeteringAssignmentStrategyUsingGET2Params {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetMeteringAssignmentStrategyUsingGET2Params) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get metering assignment strategy using g e t 2 params
func (o *GetMeteringAssignmentStrategyUsingGET2Params) WithTimeout(timeout time.Duration) *GetMeteringAssignmentStrategyUsingGET2Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get metering assignment strategy using g e t 2 params
func (o *GetMeteringAssignmentStrategyUsingGET2Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get metering assignment strategy using g e t 2 params
func (o *GetMeteringAssignmentStrategyUsingGET2Params) WithContext(ctx context.Context) *GetMeteringAssignmentStrategyUsingGET2Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get metering assignment strategy using g e t 2 params
func (o *GetMeteringAssignmentStrategyUsingGET2Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get metering assignment strategy using g e t 2 params
func (o *GetMeteringAssignmentStrategyUsingGET2Params) WithHTTPClient(client *http.Client) *GetMeteringAssignmentStrategyUsingGET2Params {
...
func (o *GetMeteringAssignmentStrategyUsingGET2Params) WithAPIVersion(aPIVersion *string) *GetMeteringAssignmentStrategyUsingGET2Params {
...
func (o *GetMeteringAssignmentStrategyUsingGET2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
