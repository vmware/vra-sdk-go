...
func (a *Client) SearchTagsUsingGET(params *SearchTagsUsingGETParams, opts ...ClientOption) (*SearchTagsUsingGETOK, error) {
	...
	if params == nil {
		params = NewSearchTagsUsingGETParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "searchTagsUsingGET",
		Method:             "GET",
		PathPattern:        "/cmx/api/resources/tags",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &SearchTagsUsingGETReader{formats: a.formats},
	...
	success, ok := result.(*SearchTagsUsingGETOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for searchTagsUsingGET: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
