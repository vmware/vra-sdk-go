...
// NewSubmitResourceActionRequestUsingPOST1Params creates a new SubmitResourceActionRequestUsingPOST1Params object,
...
func NewSubmitResourceActionRequestUsingPOST1Params() *SubmitResourceActionRequestUsingPOST1Params {
	return &SubmitResourceActionRequestUsingPOST1Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewSubmitResourceActionRequestUsingPOST1ParamsWithTimeout creates a new SubmitResourceActionRequestUsingPOST1Params object
...
// NewSubmitResourceActionRequestUsingPOST1ParamsWithContext creates a new SubmitResourceActionRequestUsingPOST1Params object
...
// NewSubmitResourceActionRequestUsingPOST1ParamsWithHTTPClient creates a new SubmitResourceActionRequestUsingPOST1Params object
...
func (o *SubmitResourceActionRequestUsingPOST1Params) WithDefaults() *SubmitResourceActionRequestUsingPOST1Params {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *SubmitResourceActionRequestUsingPOST1Params) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the submit resource action request using p o s t 1 params
func (o *SubmitResourceActionRequestUsingPOST1Params) WithTimeout(timeout time.Duration) *SubmitResourceActionRequestUsingPOST1Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the submit resource action request using p o s t 1 params
func (o *SubmitResourceActionRequestUsingPOST1Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the submit resource action request using p o s t 1 params
func (o *SubmitResourceActionRequestUsingPOST1Params) WithContext(ctx context.Context) *SubmitResourceActionRequestUsingPOST1Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the submit resource action request using p o s t 1 params
func (o *SubmitResourceActionRequestUsingPOST1Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the submit resource action request using p o s t 1 params
func (o *SubmitResourceActionRequestUsingPOST1Params) WithHTTPClient(client *http.Client) *SubmitResourceActionRequestUsingPOST1Params {
...
func (o *SubmitResourceActionRequestUsingPOST1Params) WithActionRequest(actionRequest *models.ResourceActionRequest) *SubmitResourceActionRequestUsingPOST1Params {
...
func (o *SubmitResourceActionRequestUsingPOST1Params) WithAPIVersion(aPIVersion *string) *SubmitResourceActionRequestUsingPOST1Params {
...
func (o *SubmitResourceActionRequestUsingPOST1Params) WithResourceID(resourceID strfmt.UUID) *SubmitResourceActionRequestUsingPOST1Params {
...
func (o *SubmitResourceActionRequestUsingPOST1Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
