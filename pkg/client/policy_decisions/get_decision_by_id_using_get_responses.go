...
func (o *GetDecisionByIDUsingGETReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDecisionByIDUsingGETOK()
...
func NewGetDecisionByIDUsingGETOK() *GetDecisionByIDUsingGETOK {
	return &GetDecisionByIDUsingGETOK{}
}
...
func (o *GetDecisionByIDUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /policy/api/policyDecisions/{id}][%d] getDecisionByIdUsingGETOK  %+v", 200, o.Payload)
}
...
func (o *GetDecisionByIDUsingGETOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
