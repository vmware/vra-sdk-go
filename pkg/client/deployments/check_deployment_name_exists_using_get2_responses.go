...
func (o *CheckDeploymentNameExistsUsingGET2OK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this check deployment name exists using g e t2 o k response has a 3xx status code
func (o *CheckDeploymentNameExistsUsingGET2OK) IsRedirect() bool {
	return false
}
...
func (o *CheckDeploymentNameExistsUsingGET2OK) IsCode(code int) bool {
	return code == 200
}
...
func (o *CheckDeploymentNameExistsUsingGET2OK) String() string {
	return fmt.Sprintf("[GET /deployment/api/deployments/names][%d] checkDeploymentNameExistsUsingGET2OK ", 200)
}
...
func (o *CheckDeploymentNameExistsUsingGET2Unauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this check deployment name exists using g e t2 unauthorized response has a 3xx status code
func (o *CheckDeploymentNameExistsUsingGET2Unauthorized) IsRedirect() bool {
	return false
}
...
func (o *CheckDeploymentNameExistsUsingGET2Unauthorized) IsClientError() bool {
	return true
}
...
func (o *CheckDeploymentNameExistsUsingGET2Unauthorized) IsServerError() bool {
	return false
}
...
func (o *CheckDeploymentNameExistsUsingGET2Unauthorized) IsCode(code int) bool {
	return code == 401
}
...
func (o *CheckDeploymentNameExistsUsingGET2Unauthorized) String() string {
	return fmt.Sprintf("[GET /deployment/api/deployments/names][%d] checkDeploymentNameExistsUsingGET2Unauthorized ", 401)
}
...
func (o *CheckDeploymentNameExistsUsingGET2NotFound) IsCode(code int) bool {
	return code == 404
}
...
func (o *CheckDeploymentNameExistsUsingGET2NotFound) String() string {
	return fmt.Sprintf("[GET /deployment/api/deployments/names][%d] checkDeploymentNameExistsUsingGET2NotFound  %+v", 404, o.Payload)
}
