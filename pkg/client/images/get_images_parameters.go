...
// WithRegionID adds the regionID to the get images params
func (o *GetImagesParams) WithRegionID(regionID *string) *GetImagesParams {
	o.SetRegionID(regionID)
	return o
}

// SetRegionID adds the regionId to the get images params
func (o *GetImagesParams) SetRegionID(regionID *string) {
	o.RegionID = regionID
}
