...
/*DeleteDraftByIDUsingDELETEOK handles this case with default header values.
...
/*DeleteDraftByIDUsingDELETEUnauthorized handles this case with default header values.
...
/*DeleteDraftByIDUsingDELETEForbidden handles this case with default header values.
...
/*DeleteDraftByIDUsingDELETENotFound handles this case with default header values.
...
func (o *DeleteDraftByIDUsingDELETENotFound) Error() string {
	return fmt.Sprintf("[DELETE /codestream/api/custom-integrations/{id}][%d] deleteDraftByIdUsingDELETENotFound ", 404)
}
...
/*DeleteDraftByIDUsingDELETEInternalServerError handles this case with default header values.
