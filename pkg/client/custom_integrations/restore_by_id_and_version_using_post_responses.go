...
/*RestoreByIDAndVersionUsingPOSTOK handles this case with default header values.
...
/*RestoreByIDAndVersionUsingPOSTUnauthorized handles this case with default header values.
...
/*RestoreByIDAndVersionUsingPOSTForbidden handles this case with default header values.
...
/*RestoreByIDAndVersionUsingPOSTNotFound handles this case with default header values.
...
func (o *RestoreByIDAndVersionUsingPOSTNotFound) Error() string {
	return fmt.Sprintf("[POST /codestream/api/custom-integrations/{id}/versions/{version}/restore][%d] restoreByIdAndVersionUsingPOSTNotFound ", 404)
}
...
/*RestoreByIDAndVersionUsingPOSTInternalServerError handles this case with default header values.
