...
/*ReleaseByIDAndVersionUsingPOSTOK handles this case with default header values.
...
/*ReleaseByIDAndVersionUsingPOSTUnauthorized handles this case with default header values.
...
/*ReleaseByIDAndVersionUsingPOSTForbidden handles this case with default header values.
...
/*ReleaseByIDAndVersionUsingPOSTNotFound handles this case with default header values.
...
func (o *ReleaseByIDAndVersionUsingPOSTNotFound) Error() string {
	return fmt.Sprintf("[POST /codestream/api/custom-integrations/{id}/versions/{version}/release][%d] releaseByIdAndVersionUsingPOSTNotFound ", 404)
}
...
/*ReleaseByIDAndVersionUsingPOSTInternalServerError handles this case with default header values.
