...
func (o *GetCatalogItemUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /catalog/api/items/{id}][%d] getCatalogItemUsingGETOK  %+v", 200, o.Payload)
}
...
func (o *GetCatalogItemUsingGETUnauthorized) Error() string {
	return fmt.Sprintf("[GET /catalog/api/items/{id}][%d] getCatalogItemUsingGETUnauthorized ", 401)
}
...
func (o *GetCatalogItemUsingGETForbidden) Error() string {
	return fmt.Sprintf("[GET /catalog/api/items/{id}][%d] getCatalogItemUsingGETForbidden ", 403)
}
...
func (o *GetCatalogItemUsingGETNotFound) Error() string {
	return fmt.Sprintf("[GET /catalog/api/items/{id}][%d] getCatalogItemUsingGETNotFound ", 404)
}
