...
func (o *GetCatalogItemsUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /catalog/api/items][%d] getCatalogItemsUsingGETOK  %+v", 200, o.Payload)
}
...
func (o *GetCatalogItemsUsingGETUnauthorized) Error() string {
	return fmt.Sprintf("[GET /catalog/api/items][%d] getCatalogItemsUsingGETUnauthorized ", 401)
}
...
func (o *GetCatalogItemsUsingGETForbidden) Error() string {
	return fmt.Sprintf("[GET /catalog/api/items][%d] getCatalogItemsUsingGETForbidden ", 403)
}
...
func (o *GetCatalogItemsUsingGETNotFound) Error() string {
	return fmt.Sprintf("[GET /catalog/api/items][%d] getCatalogItemsUsingGETNotFound ", 404)
}
