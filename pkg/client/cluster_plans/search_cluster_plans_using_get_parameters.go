...
// WithCloudAccountID adds the cloudAccountID to the search cluster plans using get params
func (o *SearchClusterPlansUsingGETParams) WithCloudAccountID(cloudAccountID *string) *SearchClusterPlansUsingGETParams {
	o.SetCloudAccountID(cloudAccountID)
	return o
}

// SetCloudAccountID adds the cloudAccountId to the search cluster plans using get params
func (o *SearchClusterPlansUsingGETParams) SetCloudAccountID(cloudAccountID *string) {
