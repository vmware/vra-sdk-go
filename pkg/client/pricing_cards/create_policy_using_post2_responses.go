...
func (o *CreatePolicyUsingPOST2Created) String() string {
	return fmt.Sprintf("[POST /price/api/private/pricing-cards][%d] createPolicyUsingPOST2Created  %+v", 201, o.Payload)
}
...
func (o *CreatePolicyUsingPOST2Unauthorized) IsSuccess() bool {
	return false
}
...
func (o *CreatePolicyUsingPOST2Unauthorized) IsCode(code int) bool {
	return code == 401
}
...
func (o *CreatePolicyUsingPOST2Unauthorized) String() string {
	return fmt.Sprintf("[POST /price/api/private/pricing-cards][%d] createPolicyUsingPOST2Unauthorized ", 401)
}
