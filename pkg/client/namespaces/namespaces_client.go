...
type ClientService interface {
	CreateUsingPOST1Mixin5(params *CreateUsingPOST1Mixin5Params, opts ...ClientOption) (*CreateUsingPOST1Mixin5OK, error)

	DeleteUsingDELETEMixin5(params *DeleteUsingDELETEMixin5Params, opts ...ClientOption) (*DeleteUsingDELETEMixin5OK, error)
	...
	UpdateUsingPUT2Mixin5(params *UpdateUsingPUT2Mixin5Params, opts ...ClientOption) (*UpdateUsingPUT2Mixin5OK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
  CreateUsingPOST1Mixin5 creates a k8 s namespace

  Create a K8S Namespace
*/
func (a *Client) CreateUsingPOST1Mixin5(params *CreateUsingPOST1Mixin5Params, opts ...ClientOption) (*CreateUsingPOST1Mixin5OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCreateUsingPOST1Mixin5Params()
	}
	op := &runtime.ClientOperation{
		ID:                 "createUsingPOST_1Mixin5",
		Method:             "POST",
		...
		Params:             params,
		Reader:             &CreateUsingPOST1Mixin5Reader{formats: a.formats},
	...
	success, ok := result.(*CreateUsingPOST1Mixin5OK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for createUsingPOST_1Mixin5: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
  DeleteUsingDELETEMixin5 deletes a k8 s namespace

  Delete a K8S Namespace by id
*/
func (a *Client) DeleteUsingDELETEMixin5(params *DeleteUsingDELETEMixin5Params, opts ...ClientOption) (*DeleteUsingDELETEMixin5OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewDeleteUsingDELETEMixin5Params()
	}
	op := &runtime.ClientOperation{
		ID:                 "deleteUsingDELETEMixin5",
		Method:             "DELETE",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &DeleteUsingDELETEMixin5Reader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*DeleteUsingDELETEMixin5OK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for deleteUsingDELETEMixin5: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
  UpdateUsingPUT2Mixin5 updates a k8 s namespace description or project

  Update a K8S Namespace description or project by providing namespace id and Namespace entity
*/
func (a *Client) UpdateUsingPUT2Mixin5(params *UpdateUsingPUT2Mixin5Params, opts ...ClientOption) (*UpdateUsingPUT2Mixin5OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUpdateUsingPUT2Mixin5Params()
	}
	op := &runtime.ClientOperation{
		ID:                 "updateUsingPUT_2Mixin5",
		Method:             "PUT",
		PathPattern:        "/cmx/api/resources/k8s/namespaces/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateUsingPUT2Mixin5Reader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*UpdateUsingPUT2Mixin5OK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for updateUsingPUT_2Mixin5: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
