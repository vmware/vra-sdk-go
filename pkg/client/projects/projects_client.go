...
func (a *Client) CountOfEntitiesInProjectUsingGET(params *CountOfEntitiesInProjectUsingGETParams, opts ...ClientOption) (*CountOfEntitiesInProjectUsingGETOK, error) {
	...
	if params == nil {
		params = NewCountOfEntitiesInProjectUsingGETParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "countOfEntitiesInProjectUsingGET",
		Method:             "GET",
		PathPattern:        "/cmx/api/projects/{projectId}/entity-count",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &CountOfEntitiesInProjectUsingGETReader{formats: a.formats},
	...
	success, ok := result.(*CountOfEntitiesInProjectUsingGETOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for countOfEntitiesInProjectUsingGET: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
