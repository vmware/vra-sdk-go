...
// NewCreateDeploymentsBulkParams creates a new CreateDeploymentsBulkParams object,
...
func NewCreateDeploymentsBulkParams() *CreateDeploymentsBulkParams {
	return &CreateDeploymentsBulkParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCreateDeploymentsBulkParamsWithTimeout creates a new CreateDeploymentsBulkParams object
...
// NewCreateDeploymentsBulkParamsWithContext creates a new CreateDeploymentsBulkParams object
...
// NewCreateDeploymentsBulkParamsWithHTTPClient creates a new CreateDeploymentsBulkParams object
...
func (o *CreateDeploymentsBulkParams) WithDefaults() *CreateDeploymentsBulkParams {
	o.SetDefaults()
	return o
}
...
func (o *CreateDeploymentsBulkParams) WithTimeout(timeout time.Duration) *CreateDeploymentsBulkParams {
...
func (o *CreateDeploymentsBulkParams) WithContext(ctx context.Context) *CreateDeploymentsBulkParams {
	o.SetContext(ctx)
	return o
}
...
func (o *CreateDeploymentsBulkParams) WithHTTPClient(client *http.Client) *CreateDeploymentsBulkParams {
...
func (o *CreateDeploymentsBulkParams) WithBody(body *models.BulkCreateDeploymentRequest) *CreateDeploymentsBulkParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create deployments bulk params
func (o *CreateDeploymentsBulkParams) SetBody(body *models.BulkCreateDeploymentRequest) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *CreateDeploymentsBulkParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
