...
// IsSuccess returns true when this get deployment requests using g e t2 o k response has a 2xx status code
func (o *GetDeploymentRequestsUsingGET2OK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get deployment requests using g e t2 o k response has a 3xx status code
func (o *GetDeploymentRequestsUsingGET2OK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get deployment requests using g e t2 o k response has a 4xx status code
func (o *GetDeploymentRequestsUsingGET2OK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get deployment requests using g e t2 o k response has a 5xx status code
func (o *GetDeploymentRequestsUsingGET2OK) IsServerError() bool {
	return false
}

// IsCode returns true when this get deployment requests using g e t2 o k response a status code equal to that given
...
func (o *GetDeploymentRequestsUsingGET2OK) String() string {
	return fmt.Sprintf("[GET /deployment/api/deployments/{deploymentId}/requests][%d] getDeploymentRequestsUsingGET2OK  %+v", 200, o.Payload)
}
...
// IsSuccess returns true when this get deployment requests using g e t2 unauthorized response has a 2xx status code
func (o *GetDeploymentRequestsUsingGET2Unauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get deployment requests using g e t2 unauthorized response has a 3xx status code
func (o *GetDeploymentRequestsUsingGET2Unauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get deployment requests using g e t2 unauthorized response has a 4xx status code
func (o *GetDeploymentRequestsUsingGET2Unauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this get deployment requests using g e t2 unauthorized response has a 5xx status code
func (o *GetDeploymentRequestsUsingGET2Unauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this get deployment requests using g e t2 unauthorized response a status code equal to that given
...
func (o *GetDeploymentRequestsUsingGET2Unauthorized) String() string {
	return fmt.Sprintf("[GET /deployment/api/deployments/{deploymentId}/requests][%d] getDeploymentRequestsUsingGET2Unauthorized ", 401)
}
...
// IsSuccess returns true when this get deployment requests using g e t2 not found response has a 2xx status code
func (o *GetDeploymentRequestsUsingGET2NotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get deployment requests using g e t2 not found response has a 3xx status code
func (o *GetDeploymentRequestsUsingGET2NotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get deployment requests using g e t2 not found response has a 4xx status code
func (o *GetDeploymentRequestsUsingGET2NotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this get deployment requests using g e t2 not found response has a 5xx status code
func (o *GetDeploymentRequestsUsingGET2NotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this get deployment requests using g e t2 not found response a status code equal to that given
func (o *GetDeploymentRequestsUsingGET2NotFound) IsCode(code int) bool {
	return code == 404
}
...
func (o *GetDeploymentRequestsUsingGET2NotFound) String() string {
	return fmt.Sprintf("[GET /deployment/api/deployments/{deploymentId}/requests][%d] getDeploymentRequestsUsingGET2NotFound  %+v", 404, o.Payload)
}
