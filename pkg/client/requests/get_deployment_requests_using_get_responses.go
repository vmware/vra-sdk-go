...
func (o *GetDeploymentRequestsUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /deployment/api/deployments/{deploymentId}/requests][%d] getDeploymentRequestsUsingGETOK  %+v", 200, o.Payload)
}
...
func (o *GetDeploymentRequestsUsingGETUnauthorized) Error() string {
	return fmt.Sprintf("[GET /deployment/api/deployments/{deploymentId}/requests][%d] getDeploymentRequestsUsingGETUnauthorized ", 401)
}
...
func (o *GetDeploymentRequestsUsingGETNotFound) Error() string {
	return fmt.Sprintf("[GET /deployment/api/deployments/{deploymentId}/requests][%d] getDeploymentRequestsUsingGETNotFound  %+v", 404, o.Payload)
}
