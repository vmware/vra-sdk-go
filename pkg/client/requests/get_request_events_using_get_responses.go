...
func (o *GetRequestEventsUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /deployment/api/requests/{requestId}/events][%d] getRequestEventsUsingGETOK  %+v", 200, o.Payload)
}
...
func (o *GetRequestEventsUsingGETUnauthorized) Error() string {
	return fmt.Sprintf("[GET /deployment/api/requests/{requestId}/events][%d] getRequestEventsUsingGETUnauthorized ", 401)
}
...
func (o *GetRequestEventsUsingGETNotFound) Error() string {
	return fmt.Sprintf("[GET /deployment/api/requests/{requestId}/events][%d] getRequestEventsUsingGETNotFound  %+v", 404, o.Payload)
}
