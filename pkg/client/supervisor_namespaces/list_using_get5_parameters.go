...
func (o *ListUsingGET5Params) WithID(id *string) *ListUsingGET5Params {
	o.SetID(id)
	return o
}
...
// bindParamListUsingGET5 binds the parameter sslInfo.peerCertificates[0].extendedKeyUsage
func (o *ListUsingGET5Params) bindParamSslInfoPeerCertificates0ExtendedKeyUsage(formats strfmt.Registry) []string {
...
// bindParamListUsingGET5 binds the parameter sslInfo.peerCertificates[0].issuerUniqueID
func (o *ListUsingGET5Params) bindParamSslInfoPeerCertificates0IssuerUniqueID(formats strfmt.Registry) []string {
...
// bindParamListUsingGET5 binds the parameter sslInfo.peerCertificates[0].keyUsage
func (o *ListUsingGET5Params) bindParamSslInfoPeerCertificates0KeyUsage(formats strfmt.Registry) []string {
...
// bindParamListUsingGET5 binds the parameter sslInfo.peerCertificates[0].subjectUniqueID
func (o *ListUsingGET5Params) bindParamSslInfoPeerCertificates0SubjectUniqueID(formats strfmt.Registry) []string {
