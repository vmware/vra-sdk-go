...
type ClientService interface {
	...
	UpdateUsingPUT1Mixin5(params *UpdateUsingPUT1Mixin5Params, opts ...ClientOption) (*UpdateUsingPUT1Mixin5OK, error)
...
/*
  UpdateUsingPUT1Mixin5 updates a k8 s cluster

  Update K8S Cluster by id
*/
func (a *Client) UpdateUsingPUT1Mixin5(params *UpdateUsingPUT1Mixin5Params, opts ...ClientOption) (*UpdateUsingPUT1Mixin5OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUpdateUsingPUT1Mixin5Params()
	}
	op := &runtime.ClientOperation{
		ID:                 "updateUsingPUT_1Mixin5",
		Method:             "PUT",
		PathPattern:        "/cmx/api/resources/k8s/clusters/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateUsingPUT1Mixin5Reader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*UpdateUsingPUT1Mixin5OK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for updateUsingPUT_1Mixin5: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
