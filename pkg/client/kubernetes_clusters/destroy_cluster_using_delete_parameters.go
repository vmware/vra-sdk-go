...
func (o *DestroyClusterUsingDELETEParams) WithID(id strfmt.UUID) *DestroyClusterUsingDELETEParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the destroy cluster using d e l e t e params
func (o *DestroyClusterUsingDELETEParams) SetID(id strfmt.UUID) {
	o.ID = id
}
