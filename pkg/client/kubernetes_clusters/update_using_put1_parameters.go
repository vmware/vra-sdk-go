...
func (o *UpdateUsingPUT1Params) WithCluster(cluster *models.K8SCluster) *UpdateUsingPUT1Params {
...
func (o *UpdateUsingPUT1Params) WithID(id strfmt.UUID) *UpdateUsingPUT1Params {
	o.SetID(id)
	return o
}
