...
/* GetTypeByIDUsingGETParams contains all the parameters to send to the API endpoint
   for the get type by Id using g e t operation.
...
// WithDefaults hydrates default values in the get type by Id using get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTypeByIDUsingGETParams) WithDefaults() *GetTypeByIDUsingGETParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get type by Id using get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTypeByIDUsingGETParams) SetDefaults() {
