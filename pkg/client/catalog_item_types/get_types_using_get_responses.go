...
/* GetTypesUsingGETOK describes a response with status code 200, with default header values.
...
/* GetTypesUsingGETUnauthorized describes a response with status code 401, with default header values.
