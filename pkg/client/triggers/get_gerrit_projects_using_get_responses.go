...
/*GetGerritProjectsUsingGETOK handles this case with default header values.
...
/*GetGerritProjectsUsingGETUnauthorized handles this case with default header values.
...
/*GetGerritProjectsUsingGETForbidden handles this case with default header values.
...
/*GetGerritProjectsUsingGETNotFound handles this case with default header values.
...
func (o *GetGerritProjectsUsingGETNotFound) Error() string {
	return fmt.Sprintf("[GET /codestream/api/gerrit-listeners/{id}/projects][%d] getGerritProjectsUsingGETNotFound ", 404)
}
...
/*GetGerritProjectsUsingGETInternalServerError handles this case with default header values.
