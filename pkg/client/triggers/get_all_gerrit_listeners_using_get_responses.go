...
/*GetAllGerritListenersUsingGETOK handles this case with default header values.
...
/*GetAllGerritListenersUsingGETUnauthorized handles this case with default header values.
...
/*GetAllGerritListenersUsingGETForbidden handles this case with default header values.
...
/*GetAllGerritListenersUsingGETNotFound handles this case with default header values.
...
func (o *GetAllGerritListenersUsingGETNotFound) Error() string {
	return fmt.Sprintf("[GET /codestream/api/gerrit-listeners][%d] getAllGerritListenersUsingGETNotFound ", 404)
}
...
/*GetAllGerritListenersUsingGETInternalServerError handles this case with default header values.
