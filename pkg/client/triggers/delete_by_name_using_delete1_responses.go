...
/*DeleteByNameUsingDELETE1OK handles this case with default header values.
...
/*DeleteByNameUsingDELETE1Unauthorized handles this case with default header values.
...
/*DeleteByNameUsingDELETE1Forbidden handles this case with default header values.
...
/*DeleteByNameUsingDELETE1NotFound handles this case with default header values.
...
func (o *DeleteByNameUsingDELETE1NotFound) Error() string {
	return fmt.Sprintf("[DELETE /codestream/api/gerrit-listeners/{project}/{name}][%d] deleteByNameUsingDELETE1NotFound ", 404)
}
...
/*DeleteByNameUsingDELETE1InternalServerError handles this case with default header values.
