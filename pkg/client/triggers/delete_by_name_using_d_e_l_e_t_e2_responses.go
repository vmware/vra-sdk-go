...
/*DeleteByNameUsingDELETE2OK handles this case with default header values.
...
/*DeleteByNameUsingDELETE2Unauthorized handles this case with default header values.
...
/*DeleteByNameUsingDELETE2Forbidden handles this case with default header values.
...
/*DeleteByNameUsingDELETE2NotFound handles this case with default header values.
...
func (o *DeleteByNameUsingDELETE2NotFound) Error() string {
	return fmt.Sprintf("[DELETE /codestream/api/gerrit-triggers/{project}/{name}][%d] deleteByNameUsingDELETE2NotFound ", 404)
}
...
/*DeleteByNameUsingDELETE2InternalServerError handles this case with default header values.
