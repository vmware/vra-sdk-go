...
/*UpdateUsingPUT1OK handles this case with default header values.
...
/*UpdateUsingPUT1Unauthorized handles this case with default header values.
...
/*UpdateUsingPUT1Forbidden handles this case with default header values.
...
/*UpdateUsingPUT1NotFound handles this case with default header values.
...
func (o *UpdateUsingPUT1NotFound) Error() string {
	return fmt.Sprintf("[PUT /codestream/api/git-webhooks/{id}][%d] updateUsingPUT1NotFound ", 404)
}
...
/*UpdateUsingPUT1InternalServerError handles this case with default header values.
