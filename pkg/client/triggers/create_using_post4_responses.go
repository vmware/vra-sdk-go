...
func (o *CreateUsingPOST4OK) Error() string {
	return fmt.Sprintf("[POST /codestream/api/gerrit-triggers][%d] createUsingPOST4OK  %+v", 200, o.Payload)
}
...
func (o *CreateUsingPOST4Unauthorized) Error() string {
	return fmt.Sprintf("[POST /codestream/api/gerrit-triggers][%d] createUsingPOST4Unauthorized ", 401)
}
...
func (o *CreateUsingPOST4Forbidden) Error() string {
	return fmt.Sprintf("[POST /codestream/api/gerrit-triggers][%d] createUsingPOST4Forbidden ", 403)
}
...
func (o *CreateUsingPOST4NotFound) Error() string {
	return fmt.Sprintf("[POST /codestream/api/gerrit-triggers][%d] createUsingPOST4NotFound  %+v", 404, o.Payload)
}
...
func (o *CreateUsingPOST4InternalServerError) Error() string {
	return fmt.Sprintf("[POST /codestream/api/gerrit-triggers][%d] createUsingPOST4InternalServerError ", 500)
}
