...
/*GetGerritProjectsUsingGET1OK handles this case with default header values.
...
/*GetGerritProjectsUsingGET1Unauthorized handles this case with default header values.
...
/*GetGerritProjectsUsingGET1Forbidden handles this case with default header values.
...
/*GetGerritProjectsUsingGET1NotFound handles this case with default header values.
...
func (o *GetGerritProjectsUsingGET1NotFound) Error() string {
	return fmt.Sprintf("[GET /codestream/api/gerrit-listeners/{project}/{name}/projects][%d] getGerritProjectsUsingGET1NotFound ", 404)
}
...
/*GetGerritProjectsUsingGET1InternalServerError handles this case with default header values.
