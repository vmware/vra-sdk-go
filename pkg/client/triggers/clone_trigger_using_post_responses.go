...
/*CloneTriggerUsingPOSTOK handles this case with default header values.
...
/*CloneTriggerUsingPOSTUnauthorized handles this case with default header values.
...
/*CloneTriggerUsingPOSTForbidden handles this case with default header values.
...
/*CloneTriggerUsingPOSTNotFound handles this case with default header values.
...
func (o *CloneTriggerUsingPOSTNotFound) Error() string {
	return fmt.Sprintf("[POST /codestream/api/gerrit-triggers/{id}][%d] cloneTriggerUsingPOSTNotFound ", 404)
}
...
/*CloneTriggerUsingPOSTInternalServerError handles this case with default header values.
