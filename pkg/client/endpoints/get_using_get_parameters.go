...
// WithAuthorization adds the authorization to the get using get params
func (o *GetUsingGETParams) WithAuthorization(authorization string) *GetUsingGETParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the get using get params
func (o *GetUsingGETParams) SetAuthorization(authorization string) {
