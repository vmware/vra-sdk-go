...
/*DeleteUsingDELETE2OK handles this case with default header values.
...
/*DeleteUsingDELETE2Unauthorized handles this case with default header values.
...
/*DeleteUsingDELETE2Forbidden handles this case with default header values.
...
/*DeleteUsingDELETE2NotFound handles this case with default header values.
...
func (o *DeleteUsingDELETE2NotFound) Error() string {
	return fmt.Sprintf("[DELETE /codestream/api/endpoints/{project}/{name}][%d] deleteUsingDELETE2NotFound ", 404)
}
...
/*DeleteUsingDELETE2InternalServerError handles this case with default header values.
