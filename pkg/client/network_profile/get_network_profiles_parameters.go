...
// WithRegionID adds the regionID to the get network profiles params
func (o *GetNetworkProfilesParams) WithRegionID(regionID *string) *GetNetworkProfilesParams {
	o.SetRegionID(regionID)
	return o
}

// SetRegionID adds the regionId to the get network profiles params
func (o *GetNetworkProfilesParams) SetRegionID(regionID *string) {
	o.RegionID = regionID
}
