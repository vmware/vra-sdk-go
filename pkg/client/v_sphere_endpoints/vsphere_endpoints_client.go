...
/*
  ...
  Get all storage classes defined in all managed supervisor clusters in a particular vSphere instnce. vSphere instnace is identified by endpoint SelfLink Id
*/
